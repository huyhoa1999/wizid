    ...
    this.parts = {
      ...
      map: function (inst) {
        var that = this,
          ...
          _mousedown, _mouseup, _mousemove, _keydown, _html, _touchstart , _touchend , _touchmove;
        ...
        _mousedown = function (event) {
          ...
          if (x >= 0 && x < width && y >= 0 && y < height) {
            ...
            $(document).on('touchmove', _mousemove);
            _mousemove(event,'click');
          }
        };
        ...
        _touchend = function (event) {
          ...
          $(document).off('touchmove', _touchmove);
        ...
        _mouseup = function (event) {
          ...
          // $(document).off('touchmove', _mousemove);
          part.on('mousedown', _mousedown);
        ...
        _touchmove = function (event) {
          ...
          if(typeof event.originalEvent.touches != 'undefined') {
              if(event.originalEvent.touches[0]['pageX'] === that.x && event.originalEvent.touches[0]['pageY'] === that.y) {
                return;
              }
              that.x = event.originalEvent.touches[0]['pageX'];
              that.y = event.originalEvent.touches[0]['pageY'];
          }
        ...
        _mousemove = function (event,name = 'unclick') {
          event.stopImmediatePropagation();
          // event.preventDefault();
      ...
      hex: function (inst) {
        var that = this,
          ...
          html = function () {
            ...
            return '<div class="ui-colorpicker-hex"><label style="font-weight:bold;">#</label>' + html + '</div>';
          };
          ...
          html = function () {
            ...
            if (!inst.inline) {
              ...
              if (inst.options.showCancelButton) {
                html += '<span class="ui-colorpicker-cancel">' + inst._getRegional('cancel') + '</span>';
              }
              html += '<span class="ui-colorpicker-ok">' + inst._getRegional('ok') + '</span>';
              html += '</div>';
            }
